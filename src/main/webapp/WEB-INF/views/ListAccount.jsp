                        ...
                        <c:forEach items="${accounts}" var="account">
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="deleteaccount?id=${account.accountId}" class="btn btn-danger btn-sm">DELETE</a>
                                    <a href="editaccount?id=${account.accountId}" class="btn btn-primary btn-sm">EDIT</a>
                                </td>
                            </tr>
                        </c:forEach>
                    </tbody>
